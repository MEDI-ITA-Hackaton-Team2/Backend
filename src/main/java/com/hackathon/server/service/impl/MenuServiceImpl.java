...
public class MenuServiceImpl implements MenuService {
    ...
    @Override
    public List<MenuRes> getMenuList(String menuNm, Long ingredientId, Long dongId, Double maxPrice) {
        return menuRepository.selectMenuList(menuNm, ingredientId, dongId, maxPrice);
    }
